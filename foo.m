...
for i = 1:rnum
    r = i*0.02;
    result(1,i) = sampen(m, r*sd1, sint,tau);%ApEn(m, r*sd1, sint, tau);
    result(2,i) = sampen(m, r*sd2, chirpt,tau);%ApEn(m,r*sd2,chirpt, tau);
    result(3,i) = sampen(m, r*sd3, whitet,tau);%ApEn(m,r*sd3,whitet, tau);
end
